...
#define operand_module 100 // número usado no resto de divisão para achar o operando de uma instrução. Ex.: 1234 % operand_module = 34
#define operation_module 100 // número usado no resto de divisão para achar a operação de uma instrucao
